...
export function RegisterPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (!PASSWORD_REGEX.test(password)) {
      setError(
        'Password must be at least 8 characters and include uppercase, lowercase, digit, and a special character.',
      );
      return;
    }
  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center">
      <div className="animate-rise w-full max-w-md rounded-3xl border border-white/10 bg-slatewave-900/75 p-8 shadow-glass backdrop-blur-xl">
        <h1 className="mb-6 text-center text-2xl font-bold text-tide-300">Create Account</h1>
